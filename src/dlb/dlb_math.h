...
#define COLOR_BLACK_HIGHLIGHT         VEC4(0.0f, 0.0f, 0.0f, 0.5f)
#define COLOR_RED_HIGHLIGHT           VEC4(1.0f, 0.0f, 0.0f, 0.5f)
#define COLOR_GREEN_HIGHLIGHT         VEC4(0.0f, 1.0f, 0.0f, 0.5f)
#define COLOR_BLUE_HIGHLIGHT          VEC4(0.0f, 0.0f, 1.0f, 0.5f)
#define COLOR_YELLOW_HIGHLIGHT        VEC4(1.0f, 1.0f, 0.0f, 0.5f)
#define COLOR_CYAN_HIGHLIGHT          VEC4(0.0f, 1.0f, 1.0f, 0.5f)
#define COLOR_MAGENTA_HIGHLIGHT       VEC4(1.0f, 0.0f, 1.0f, 0.5f)
#define COLOR_WHITE_HIGHLIGHT         VEC4(1.0f, 1.0f, 1.0f, 0.5f)
#define COLOR_GRAY_HIGHLIGHT          VEC4(0.5f, 0.5f, 0.5f, 0.5f)
